...
namespace gcgcg
{
    internal class Spline : Objeto
    {
        ...
        public List<Ponto4D> pontosLista { get; set; }
        ...
        public void setPontos(List<Ponto4D> listaPontos) {
            pontosLista = listaPontos;
        }

        public void DesenharObjeto()
        {
            ...
            base.PontosAdicionar(new Ponto4D(ponto1.X, ponto1.Y));
            for (double i = 0; i < quantidadePontos; i++)
            {
                ...
                base.PontosAdicionar(new Ponto4D(resultado.X, resultado.Y));
            }
            base.PontosAdicionar(new Ponto4D(ponto4.X, ponto4.Y));
            base.ObjetoAtualizar();
        }
